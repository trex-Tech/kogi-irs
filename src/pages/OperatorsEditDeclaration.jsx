...
const OperatorsEditDeclaration = () => {
  ...
  const { id: reference_code } = useParams();
  ...
  const sendDeclaration = () => {
    ...
    if (
      ...
      if (token) {
        axios
          .patch(
            `${BACKEND_URL}/api/tax-submission/edit/${reference_code}/`,
            data,
            {
              headers: {
                Authorization: `Bearer ${token}`,
...
export default OperatorsEditDeclaration;
